...
exports.register = asyncHandler(async (req, res, next) => {
  ...
  const message = `You are receiving this email because you registered an account with Lumina. Please verify your email by clicking on the following link: \n\n ${verificationUrl} \n\nIf you did not make this request, please ignore this email.`;

  try {
    await sendEmail({
      email: user.email,
      subject: 'Lumina - Email Verification',
      message
    });
